...
class Log:
    ...
    @staticmethod
    def init(logger_name='photolog', log_level='debug', log_filepath='photolog/resource/photolog.log'):
        Log.__my_logger = getLogger(logger_name)
        Log.__my_logger.setLevel(Log.__log_levle_map.get(log_level, 'warn'))
